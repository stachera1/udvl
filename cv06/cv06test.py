...
from tableau import Tableau, Node, signedFormToString, ALPHA, BETA
...
try:
    ...
    t.testTableau(True, [ (False, Implication(Var('a'), Var('a'))) ])

    t.testTableau(True, [ (False, Or(a, Not(a))) ])

    t.testTableau(True, [ (True, a), (False, a) ])

    t.testTableau(True, [ (True, a), (False, a), (True, a) ])

    t.testTableau(True, [ (True, a), (False, a), (True, b) ])
