/**
 * Ukazkovy program riesiaci NQueens pomocou SAT solvera.
 *
 * Skompilovat ho mozete prikazom
 *
 * g++ -std=c++11 -o nqueens nqueens.cpp ../../examples/sat/sat.cpp -I../../examples/sat/
 *
 */
#include "nqueens.h"
